...
echo "------------------------------------------------------------------"
echo "Running music... | Rerender + Postprocess + Eval"
echo "------------------------------------------------------------------"
...
python rerender.py --cfg config/music_rerender.json -eval
...
python rerender.py --cfg config/music_keypoint_dp_1020.json -eval
...
echo "------------------------------------------------------------------"
echo "[TIME] dp_start: $(date +"%T")"
python rerender.py --cfg config/music_keypoint_dp_1530.json -eval
echo "[TIME] dp_end  : $(date +"%T")"
echo "------------------------------------------------------------------"
echo -e "------------------------------------------------------------------\n\n\n\n\n\n\n"
...
echo "------------------------------------------------------------------"
echo "[TIME] bin_start: $(date +"%T")"
python rerender.py --cfg config/music_keypoint_bin_1530.json -eval
echo "[TIME] bin_end  : $(date +"%T")"
echo "------------------------------------------------------------------"
echo -e "------------------------------------------------------------------\n\n\n\n\n\n\n"
