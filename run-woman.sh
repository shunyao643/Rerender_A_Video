...
echo "------------------------------------------------------------------"
echo "Running woman_keypoint... | Rerender + Postprocess + Eval"
echo "------------------------------------------------------------------"
...
python rerender.py --cfg config/woman_keypoint_bin.json -eval
echo "------------------------------------------------------------------"
...
python rerender.py --cfg config/woman_keypoint_dp.json -eval
echo "------------------------------------------------------------------"
